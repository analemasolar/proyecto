...
#define CONFIGURE_ARGS " '--prefix=/usr/local/Caskroom/miniforge/base/envs/proyecto' '--with-readline' '--with-libraries=/usr/local/Caskroom/miniforge/base/envs/proyecto/lib' '--with-includes=/usr/local/Caskroom/miniforge/base/envs/proyecto/include' '--with-openssl' '--with-uuid=e2fs' '--with-libxml' '--with-libxslt' '--with-gssapi' '--with-system-tzdata=/usr/local/Caskroom/miniforge/base/envs/proyecto/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-apple-darwin13.4.0' 'host_alias=arm64-apple-darwin20.0.0' 'CC=arm64-apple-darwin20.0.0-clang' 'CFLAGS=-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /usr/local/Caskroom/miniforge/base/envs/proyecto/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/postgresql-split_1696003544170/work=/usr/local/src/conda/postgresql-split-15.4 -fdebug-prefix-map=/usr/local/Caskroom/miniforge/base/envs/proyecto=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/usr/local/Caskroom/miniforge/base/envs/proyecto/lib -L/usr/local/Caskroom/miniforge/base/envs/proyecto/lib' 'CPPFLAGS=-D_FORTIFY_SOURCE=2 -isystem /usr/local/Caskroom/miniforge/base/envs/proyecto/include -mmacosx-version-min=11.0' 'CXX=arm64-apple-darwin20.0.0-clang++' 'CXXFLAGS=-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -fmessage-length=0 -isystem /usr/local/Caskroom/miniforge/base/envs/proyecto/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/postgresql-split_1696003544170/work=/usr/local/src/conda/postgresql-split-15.4 -fdebug-prefix-map=/usr/local/Caskroom/miniforge/base/envs/proyecto=/usr/local/src/conda-prefix' 'CLANG=arm64-apple-darwin20.0.0-clang' 'PKG_CONFIG_PATH=/usr/local/Caskroom/miniforge/base/envs/proyecto/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 15.4 on aarch64-apple-darwin20.0.0, compiled by clang version 15.0.7, 64-bit"
